...
export const strapiClient = {
  ...
  getBlogPost: (slug: string, locale: Locale = 'es'): Promise<StrapiResponse<BlogPost[]>> =>
    strapiRequest(`/api/blog-posts?filters[slug][$eq]=${slug}&populate[category]=*&populate[categories]=*&populate[featuredImage]=*&populate[page_blocks]=*&populate[seo]=*&populate[author][populate][0]=photo&populate[author][populate][1]=social_links&locale=${STRAPI_LOCALE[locale]}`),
  ...
  getCaseStudy: (slug: string, locale: Locale = 'es'): Promise<StrapiResponse<CaseStudy[]>> =>
    strapiRequest(`/api/case-studies?filters[slug][$eq]=${slug}&populate[categories]=*&populate[cover_image]=*&populate[page_blocks]=*&populate[author][populate][0]=photo&populate[author][populate][1]=social_links&locale=${STRAPI_LOCALE[locale]}`),
